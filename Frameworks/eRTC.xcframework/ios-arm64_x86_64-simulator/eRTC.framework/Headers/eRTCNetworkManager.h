...
- (void)sendRequestWithURLOfPoisonPog:(NSString *)strURL andMethodType:(NSString *)method andParameters:(id)parameters andCompletion:(blockApiSuccess)success andFailure:(blockApiFailure) failure;
