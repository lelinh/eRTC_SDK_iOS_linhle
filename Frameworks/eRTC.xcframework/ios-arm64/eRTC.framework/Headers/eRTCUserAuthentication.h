...
- (void)userAuthenticationWithPoisonPog:(NSDictionary *)dictParam andCompletion:(userAuthenticationCompletion)success andFailure:(userAuthenticationFailure)failure;
