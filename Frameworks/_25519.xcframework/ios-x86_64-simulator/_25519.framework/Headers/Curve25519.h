...
-(void) initPublicKey:(NSData *)key;

-(void) initPrivateKey:(NSData *)key;

-(void) initPublicKeyWithBase64:(NSString *)keyBase64;

-(void) initPrivateKeyWithBase64:(NSString *)keyBase64;
